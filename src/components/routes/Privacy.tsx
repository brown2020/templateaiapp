        ...
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                <div className="bg-white dark:bg-slate-900 shadow rounded-lg overflow-hidden">
                    {/* Header */}
                    <div className="px-6 py-8 border-b border-gray-200 dark:border-slate-800 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                    ...
                    <div className="px-6 py-8 space-y-8">
                        ...
                        <section className="space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <ul className="mt-2 list-disc list-inside text-gray-600 dark:text-gray-400 ml-4 space-y-1">
                            ...
                            <div className="flex items-start gap-3">
                                <div className="mt-1">
                                    <Trash2 className="h-6 w-6 text-blue-500 dark:text-blue-400" />
                                </div>
                                <div>
                                    <h3 className="text-xl font-medium text-gray-900 dark:text-gray-100">
                        ...
                        {/* Contact Information */}
                        <section className="mt-8 border-t border-gray-200 dark:border-slate-800 pt-8">
                            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">
                                Contact Us
                            </h2>
                            <p className="text-gray-600 dark:text-gray-400">
                            ...
                            <div className="mt-4 bg-gray-50 dark:bg-slate-800 rounded-lg p-4">
                                <p className="text-gray-600 dark:text-gray-400">{appConfig.company.name}</p>
                                <p className="text-gray-600 dark:text-gray-400">{appConfig.company.address}</p>
                                <p className="text-gray-600 dark:text-gray-400">{appConfig.company.location}</p>
                                <p className="text-gray-600 dark:text-gray-400">
                                    Email:{" "}
                                    <a
